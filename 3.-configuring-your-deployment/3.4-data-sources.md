...
* Then, click on _**Data Sources**_.![](../.gitbook/assets/updated_data_sources.png)
* You should get a full list of data sources as shown below![](../.gitbook/assets/screen-shot-2018-03-26-at-00.05.41.png)
...
* Click on _**the drop down icon on the right as shown**_![](../.gitbook/assets/email.png)
* Input the following email account settings:-
  ...
  * _**Email sender name**_: This is what appears in the “from” field in outgoing emails.![](../.gitbook/assets/email_1.png)![](../.gitbook/assets/email_2.png)
...
* Setup the FrontlineSMS data source on your Ushahidi platform
  * Click on the drop down icon on the right as shown![](../.gitbook/assets/frontline.png)
...
* Click on _**the drop down icon on the right to get to your Nexmo configuration page**_![](../.gitbook/assets/nexmo.png)
...
* To enable/disable the nexmo data source, simply click on the green toggle.![Toggle\_Nexmo.png](../.gitbook/assets/togglenexmo.png)
...
* Click on _**the drop down icon on the right as shown**_![](../.gitbook/assets/smssync.png)
...
* Go back to your Data source settings page on your deployment
* Click on _**the drop down icon on the right as shown**_![](../.gitbook/assets/twilio.png)
...
* Click on “Create New App”![](../.gitbook/assets/twitter.png)

![Screen\_Shot\_2016-04-14\_at\_12\_40\_12\_PM.png](../.gitbook/assets/screenshot_2016_-04-14at_12_40_12.png)
...
![Edit\_Twitter.png](../.gitbook/assets/edittwitter.png)
