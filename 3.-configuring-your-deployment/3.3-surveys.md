...
![&quot;Plus&quot; button in a Ushahidi deployment. Click the + button to create a new survey.](../.gitbook/assets/click__add_survey.png)

* Fill in the required details.

![Creating a survey with a Survey name, survey description.](../.gitbook/assets/survey_add.png)
...
![Adding field options for a new field.](../.gitbook/assets/add_field-2.png)
...
![Modal with field editor. Edit the field name and display options.](../.gitbook/assets/edit_field.png)
...
![Using the &quot;Configure&quot; tab in the survey editor.](../.gitbook/assets/configure_survey_2.png)
...
![Selecting a survey to edit it from the list of surveys.](../.gitbook/assets/select_a_survey_to_edit.png)
...
![Context menu in the survey list. Click on the &quot;...&quot; button and then &quot;Delete&quot; to delete it.](../.gitbook/assets/dotted_survey_list.png)
...
![Popup warning when clicking the Delete link for surveys.](../.gitbook/assets/confirm_delete_survey.png)
