...
* Click on the yellow add icon as shown below on your homepage, or on the bottom left corner on the data mode page![](../.gitbook/assets/click_on_add_post.png)
* In the event that you have multiple surveys on your deployment, you’ll have to choose the survey from a list of all surveys available on your deployment.![](../.gitbook/assets/select_a_survey.png)
...
* When you’re done adding content for your post, click on _**Submit**_![](../.gitbook/assets/submit_post.png)
